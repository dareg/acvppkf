...
REAL , DIMENSION(KLON,KLEV):: SHAL_ZTTENS, SHAL_ZRVTENS, SHAL_ZRCTENS, SHAL_ZRITENS, SHAL_ZUMFS
...
!  CALL INI_CONVPAR_SHAL
  ...
  CALL SHALLOW_CONVECTION( KLON, KLEV, KIDIA, KFDIA, I_KBDIA, KTDIA,        &
   ...
   & SHAL_ZTTENS, SHAL_ZRVTENS, SHAL_ZRCTENS, SHAL_ZRITENS,          &
   & SHAL_ICLTOPS, SHAL_ICLBASS, SHAL_ZUMFS, &
   & LLOCHTRANS, I_KCH1, SHAL_ZCH1, SHAL_ZCH1TENS )

DO JK = 1, KLEV
  DO JI = KIDIA, KFDIA
    SHAL_ZTTEN(JI,JK) = SHAL_ZTTENS(JI,JK)
    SHAL_ZRVTEN(JI,JK) = SHAL_ZRVTENS(JI,JK)
    SHAL_ZRCTEN(JI,JK) = SHAL_ZRCTENS(JI,JK)
    SHAL_ZRITEN(JI,JK) = SHAL_ZRITENS(JI,JK)
    SHAL_ZUMF(JI,JK)   = SHAL_ZUMFS(JI,JK)
  ENDDO
ENDDO
DO JI = KIDIA, KFDIA
