!OPTIONS XOPT(NOEVAL)
!-----------------------------------------------------------------
SUBROUTINE ACVPPKF( YDCST,YDML_PHY_MF,CST,KIDIA,KFDIA,KLON,KTDIA,KLEV, &
 !-----------------------------------------------------------------
 ! - INPUT  2D .
...
REAL(KIND=JPRB) :: ZCH1   (KLON,KLEV,I_KCH1)
REAL(KIND=JPRB) :: ZCH1TEN(KLON,KLEV,I_KCH1)
...
!             -------------------------------
  ...
  CALL SHALLOW_CONVECTION(CVP_SHAL, CST, KLON, KLEV, KIDIA, KFDIA, I_KBDIA, KTDIA,        &
