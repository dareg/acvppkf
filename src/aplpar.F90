...
USE MODD_CST, ONLY: CST_T, CST_INIT
USE MODD_NSV, ONLY : NSV_T, NSV_LGBEG, NSV_LGEND
USE MODD_DIMPHYEX, ONLY: DIMPHYEX_T
USE MODD_CONVPAR, ONLY: CONVPAR_T, XTFRZ1, XTFRZ2
...
!     ------------------------------------------------------------------
  ...
  IF (LCVPPKF) THEN
    ...
    NSV%NSV_LGBEG = NSV_LGBEG
    NSV%NSV_LGEND = NSV_LGEND
    CALL INI_CONVPAR
    CONVPAR%XTFRZ1 = XTFRZ1
    CONVPAR%XTFRZ2 = XTFRZ2
    CALL CST_INIT(CST)

    CALL ACVPPKF(YDCST,YDMODEL%YRML_PHY_MF, CST, D, NSV, CONVPAR, NTCVIM,                                                 &
