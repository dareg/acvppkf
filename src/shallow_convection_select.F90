SUBROUTINE SHALLOW_CONVECTION_SELECT( CVP_SHAL, CVPEXT, CST, KLON, ICONV, KLEV, KIDIA, KFDIA, KICE, OSETTADJ,&
...
CALL SHALLOW_CONVECTION_COMPUTE(CVP_SHAL, CVPEXT, CST, ICONV, KLEV, KIDIA, ICONV, KICE,       &
