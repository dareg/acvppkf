...
!
SUBROUTINE CST_INIT(TOINIT)
  IMPLICIT NONE
  TYPE(CST_T), INTENT(INOUT) :: TOINIT
  TOINIT%XPI=CST%XPI
  TOINIT%XDAY=CST%XDAY
  TOINIT%XSIYEA=CST%XSIYEA
  TOINIT%XSIDAY=CST%XSIDAY
  TOINIT%XKARMAN=CST%XKARMAN
  TOINIT%XLIGHTSPEED=CST%XLIGHTSPEED
  TOINIT%XPLANCK=CST%XPLANCK
  TOINIT%XBOLTZ=CST%XBOLTZ
  TOINIT%XAVOGADRO=CST%XAVOGADRO
  TOINIT%XRADIUS=CST%XRADIUS
  TOINIT%XOMEGA=CST%XOMEGA
  TOINIT%XG=CST%XG
  TOINIT%XP00=CST%XP00
  TOINIT%XP00OCEAN=CST%XP00OCEAN
  TOINIT%XRH00OCEAN=CST%XRH00OCEAN
  TOINIT%XSTEFAN=CST%XSTEFAN
  TOINIT%XI0=CST%XI0
  TOINIT%XMD=CST%XMD
  TOINIT%XMV=CST%XMV
  TOINIT%XRD=CST%XRD
  TOINIT%XRV=CST%XRV
  TOINIT%XEPSILO=CST%XEPSILO
  TOINIT%XCPD=CST%XCPD
  TOINIT%XCPV=CST%XCPV
  TOINIT%XRHOLW=CST%XRHOLW
  TOINIT%XCL=CST%XCL
  TOINIT%XCI=CST%XCI
  TOINIT%XTT=CST%XTT
  TOINIT%XLVTT=CST%XLVTT
  TOINIT%XLSTT=CST%XLSTT
  TOINIT%XLMTT=CST%XLMTT
  TOINIT%XESTT=CST%XESTT
  TOINIT%XALPW=CST%XALPW
  TOINIT%XBETAW=CST%XBETAW
  TOINIT%XGAMW=CST%XGAMW
  TOINIT%XALPI=CST%XALPI
  TOINIT%XBETAI=CST%XBETAI
  TOINIT%XGAMI=CST%XGAMI
  TOINIT%XCONDI=CST%XCONDI
  TOINIT%XALPHAOC=CST%XALPHAOC
  TOINIT%XBETAOC=CST%XBETAOC
  TOINIT%XTH00=CST%XTH00
  TOINIT%XTH00OCEAN=CST%XTH00OCEAN
  TOINIT%XSA00OCEAN=CST%XSA00OCEAN
  TOINIT%XROC=CST%XROC
  TOINIT%XD1=CST%XD1
  TOINIT%XD2=CST%XD2
  TOINIT%XRHOLI=CST%XRHOLI
  TOINIT%NDAYSEC=CST%NDAYSEC
  TOINIT%RDSRV=CST%RDSRV
  TOINIT%RDSCPD=CST%RDSCPD
  TOINIT%RINVXP00=CST%RINVXP00
  TOINIT%XMNH_TINY=CST%XMNH_TINY
  TOINIT%XMNH_TINY_12=CST%XMNH_TINY_12
  TOINIT%XMNH_EPSILON=CST%XMNH_EPSILON
  TOINIT%XMNH_HUGE=CST%XMNH_HUGE
  TOINIT%XMNH_HUGE_12_LOG=CST%XMNH_HUGE_12_LOG
  TOINIT%XEPS_DT=CST%XEPS_DT
  TOINIT%XRES_FLAT_CART=CST%XRES_FLAT_CART
  TOINIT%XRES_OTHER=CST%XRES_OTHER
  TOINIT%XRES_PREP=CST%XRES_PREP
